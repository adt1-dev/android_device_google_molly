The defualt ADT-1 (Molly) CM-12.0 configuration is limited to TV features., i.e. no Navigation Bar/Status Bar. The goal of the cm-12.0-tablet branch is to restore the defualt CyanogenMod Tablet Configuration.

To opt to use this instead of the default TV configuration, edit your roomservice.xml, and append this to the end of the "device/google/molly" entry: revision="cm-12.0-tablet"
